...
# print(type(obj))
# requests.post
r = requests.post('http://kd.youth.cn/TaskCenter/sign',headers=headers);
print(r.json(),r.status_code)
# print(type(headers))
# print(type(obj))
def Sign():
  try:
    r = requests.post('http://kd.youth.cn/TaskCenter/sign',headers=obj);
    if r.status_code == 2:
      print('签到失败，Cookie已失效‼️')
      return;
    elif r.status_code == 1:
      print('签到成功，明日{}'.format(r.nextScore))
